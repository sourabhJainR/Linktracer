...
function render(model){
  ...
  const priority={Conflicted:0,'Research Needed':1,Review:2,'Decision Ready':3};
  const topics=[...model.topics].sort((a,b)=>(priority[a.readiness]-priority[b.readiness])||a.avgEvidence-b.avgEvidence).slice(0,8);
